        ...
        <div v-if="activeTab === 'guide'" class="space-y-3 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div class="mt-2 space-y-3 pl-5 border-l-2 border-blue-200 dark:border-blue-800 ml-0.5">
              <div>
                <div class="font-semibold mb-0.5">
                  <span class="inline-flex items-center justify-center w-4.5 h-4.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-[10px] mr-1 shrink-0">①</span>
                  输入文本
                </div>
          ...
          <details open class="group">
            ...
            <div class="mt-2 space-y-3 pl-5 border-l-2 border-green-200 dark:border-green-800 ml-0.5">
              <div>
                <div class="font-semibold mb-0.5">
                  <span class="inline-flex items-center justify-center w-4.5 h-4.5 rounded-full bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 text-[10px] mr-1 shrink-0">②</span>
                  划词查询
                </div>
          ...
          <details class="group">
            ...
            <div class="mt-2 space-y-3 pl-5 border-l-2 border-purple-200 dark:border-purple-800 ml-0.5">
              <div>
                <div class="font-semibold mb-0.5">
                  <span class="inline-flex items-center justify-center w-4.5 h-4.5 rounded-full bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 text-[10px] mr-1 shrink-0">⑤</span>
                  保存结果
                </div>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li class="flex items-start gap-2.5">
                <span class="text-blue-500 shrink-0 text-lg">📖</span>
                <div>
              ...
              <li class="flex items-start gap-2.5">
                <span class="text-green-600 shrink-0 text-lg">📜</span>
                <div>
              ...
              <li class="flex items-start gap-2.5">
                <span class="text-amber-600 shrink-0 text-lg">📚</span>
                <div>
              ...
              <li class="flex items-start gap-2.5">
                <span class="text-purple-600 shrink-0 text-lg">🏛️</span>
                <div>
