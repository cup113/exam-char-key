...
<template>
    <div class="min-h-24 px-4 py-2 shadow-lg flex flex-col gap-2 w-full">
        ...
        <div class="text-center text-xl font-bold bg-green-200 mx-auto px-4 rounded-xl">
            <p v-for="answer in queryStore.thoughtStructured.answers" :key="answer.answer">
        ...
        <div class="indent-4">
            <div v-for="candidate in queryStore.thoughtStructured.candidates" :key="candidate.answer">
